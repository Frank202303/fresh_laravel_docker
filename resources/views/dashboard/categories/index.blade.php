                ...
                <table class="w-full divide-y divide-gray-200">
                    ...
                    <tbody class="text-xs divide-y divide-gray-200  bg-indigo-50">
                        <tr>
                            ...
                            <td class="px-2 py-4 whitespace-nowrap">ID</td>
                            <td class="px-2 py-4 whitespace-nowrap">Name</td>
                            <td class="px-2 py-4 whitespace-nowrap">Subcatogeries</td>
                            <td class="px-2 py-4 whitespace-nowrap">Created at</td>
                            <td class="px-2 py-4 whitespace-nowrap">Updated at</td>
                            <td class="px-2 py-4 whitespace-nowrap">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="">
                                        <a href="">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 bg-red-400">
                                                <path stroke-linecap="round" stroke-linejoin="round"
